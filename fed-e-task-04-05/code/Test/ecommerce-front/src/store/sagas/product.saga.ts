...
import { GET_PRODUCT, GetProductAction, getProductSuccess } from "../actions/product.actions";
import axios from "axios";
import { API } from "../../config";
import { Product } from "../models/product";
import { getProductByIdSuccess } from "../actions/product.actions";
import { GET_PRODUCT_BY_ID, GetProductByIdAction } from "../actions/product.actions";
import { FilterProductAction, filterProductSuccess } from "../actions/product.actions";
import { SearchProductSuccess, FILTER_PRODUCT } from "../actions/product.actions";
import { SEARCH_PRODUCT, SearchProductAction } from "../actions/product.actions";
